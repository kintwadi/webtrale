...
//        
    ...
    private ArrayList<Span> getSpans(ArrayList<String> successfullPartialAnalyses, String q) {
        ...
        for (String anAnalysis : successfullPartialAnalyses) {
            ...
            // e.g., <result id='10'><view><title>the professor</title><tree label="[hd_spr_rule,the,professor]  ||  NP[case]  ||  the_professor(0)"><content><fs type="hd_spr_ph"><ls>
           // System.out.println("anAnalysis: " + anAnalysis);
            // e.g.: [lexicon,professor]
            // or [hd_spr_rule,the,professor]
            // note that an error here is related to a version conflict in TRALE.
            // TREE LABEL VERSION !!!
