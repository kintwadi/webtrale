...
public class Trale {
    ...
    static class TraleException extends RuntimeException {
        ...
        TraleException(Throwable cause) {
            super(cause);
        }

        TraleException(String msg) {
            super(msg);
        }
    }
    ...
    synchronized public String[] rec(String q, int maxParses, int maxWords, String description) {
        // original rec command in Webtrale 0.1
    ...
    private String readLineTest() throws UnsupportedEncodingException, IOException {
